...
public class MainEx01 {
	public static void main(String[] args) {
		...
		//삼각함수 : sin, cos, tan => 각도의 단위가 라디안(Radians)
		System.out.println(Math.sin(Math.PI/2)); //sin(90)
		System.out.println(Math.cos(Math.PI/3)); //cos(60)
		System.out.println(Math.tan(Math.PI/4)); //tan(45)
		//toDegrees : 라디안 => Degress 단위로 변경
		System.out.println(Math.toDegrees(Math.PI/3));
		//toRadians : Degress => Radians 단위로 변경
