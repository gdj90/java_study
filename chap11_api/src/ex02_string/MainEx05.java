 ...
 *    %c : char
 *    
 *  String String.format("서식문자를 포함하는 문자열",값1,값2...) => 문자열로 리턴
 *  System.out.printf("서식문자를 포함하는 문자열",값1,값2...)   => 화면에 출력
 */
public class MainEx05 {
	public static void main(String[] args) {
		// %d : 10진 정수
		String sf = String.format("%d", 12345);
		System.out.println(sf); // 12345
		// %,d : 3자리마다 , 찍은 10진 정수
		sf = String.format("%,d", 12345);
		System.out.println(sf);
		// %,10d : 10자리 확보하여 3자리마다 , 찍은 10진 정수
		sf = String.format("%,10d", 12345);
		System.out.println(sf);
		// %-,10d : 10자리 확보하여 3자리마다 , 찍은 10진 정수를 왼쪽부터 출력. 좌측정렬
		sf = String.format("%-,10d", 12345);
		System.out.println(sf);
		// %010d : 10자리 확보하여 나머지부분은 0으로 채운 10진 정수
		sf = String.format("%010d", 12345);
		System.out.println(sf);
		// %X, %x : 16진 정수 출력. X:대문자알파벳, x:소문자알파벳 출력
		...
		System.out.println(String.format("%-,15.2f", 12345.145));
		// %015.2f : 15자리 확보하고, 소숫점이하 2자리로, 빈자리를 0으로 채우기. -표시불가
