...
/*
 * 객체 추가시 중복판단의 기준
 *   1. equals 메서드의 결과 true
 *   2. hashCode 메서딍 결과가 같은 경우
 *   1,2 모두 만족한는 경우를 중복객체로 판단함
 *   
 *   equals, hashCode 메서드를 동시에 오버라이딩필요
 */
class Person {
	String name;
	int age;
...
//			return false;
		if(obj instanceof Person) {
		   ...
		   //Objects.equals(obj1,obj2) : null 안전성 처리함
