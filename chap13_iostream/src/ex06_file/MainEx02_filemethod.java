 ...
 * - boolean mkdirs() : 폴더 생성. 여러단계의 폴더 생성
 * - boolean createNewFile() : 파일 생성. IOException예외처리
 * - String getName() : 파일의 이름리턴
 * - long length()   : 파일의 크기. 바이트 단위
 * - boolean renameTo(File) : 파일을 변경
...
public class MainEx02_filemethod {
	public static void main(String[] args) throws IOException {
		...
		String lastday = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").
				     format(f3.lastModified());
