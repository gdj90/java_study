 ...
 *    Hashtable, HashMap   
 *    
 * 동기화 영역 : synchronized 예약어 사용. 임계영역
 *   1. 동기화블럭 : synchronized{  ...   } 
 *   2. 동기화메서드 : 메서드의 선언부에 synchronized void method()...  
 */
...
//		Printer prt3 = new Printer();
		PrintThread3 t1 = new PrintThread3(prt,'A');//t
